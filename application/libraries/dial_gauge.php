...
define('BLANK_DIAL',"img/gauge_blank.png");	// A blank gauge Image
define('BLANK_IMG' ,"img/blank.png");			// A blank PNG Image
define('NEEDLE'    ,"img/gauge_needle.png");		// Our Needle Image
