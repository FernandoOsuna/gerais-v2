...
<div data-role="page">
	...
	<div data-role="header" data-theme="b"><h1>
		<?php echo (isset($header))? $header :'GeRAIS'; ?></h1>
		<?php if(isset($home_url)){ ?>
			<a href="<?php echo site_url($home_url); ?>" data-icon="home" data-iconpos="notext" data-direction="reverse">Inicio</a>
		<?php } ?>
	...
	<div data-role="footer" data-theme="c"><h4>
		<?php echo (isset($footer))? $footer :'Sistema GeRAIS'; ?></h4>
	</div>
