	...
	function chfecha($validar){
		...
		if(preg_match($pattern,$validar)>0){
			...
			if(!checkdate($mes,$dia,$anio)){
				$this->_error_messages['chfecha']="La fecha introducida en el campo <b>%s</b> no es v&aacute;lida";
				//$this->set_message($fnombre, "La fecha introducida en el campo <b>%s</b> no es v&aacute;lida");
				return false;
			}
		}else{
			$this->_error_messages['chfecha']= "La fecha introducida en el campo <b>%s</b> no coincide con el formato";
